...
export const DOCUMENTS: DocumentItem[] = [
  // Property Documents
  { name: 'Land Title', filename: 'land_title.pdf', uploadedDate: 'Sun-Apr 14, 2026', status: 'Approved' },
  { name: 'Tax Declaration', filename: 'tax_declaration.pdf', uploadedDate: 'Sun-Apr 14, 2026', status: 'Approved' },
  { name: 'Real Property Tax Receipt', filename: 'rpt_receipt.pdf', uploadedDate: 'Sun-Apr 14, 2026', status: 'Approved' },
  // Technical Documents
  { name: 'Plans', filename: 'building_plans.pdf', uploadedDate: 'Sun-Apr 14, 2026', status: 'Approved' },
  { name: 'Specifications', filename: 'specifications.pdf', uploadedDate: 'Sun-Apr 14, 2026', status: 'Missing' },
  { name: 'Bill of Materials', filename: 'bill_of_materials.pdf', uploadedDate: 'Sun-Apr 14, 2026', status: 'Pending' },
  ...
  { name: 'Signed Forms', filename: 'signed_forms.pdf', uploadedDate: 'Sun-Apr 14, 2026', status: 'Rejected' },
  // Government Clearances
  { name: 'Barangay Clearance', filename: 'barangay_clearance.pdf', uploadedDate: 'Sun-Apr 14, 2026', status: 'Approved' },
  { name: 'Zoning Clearance', filename: 'zoning_clearance.pdf', uploadedDate: 'Sun-Apr 14, 2026', status: 'Pending' },
  { name: 'Fire-Related Requirements', filename: 'fire_requirements.pdf', uploadedDate: 'Sun-Apr 14, 2026', status: 'Missing' },
];

export const COMMENTS: CommentItem[] = [
  { author: 'Engr. Ricardo Buenaflor', timeAgo: 'about 2 minutes ago', text: 'Initial Interview Done!', depth: 0, thumbnails: ['#8b5a2b', '#1f2430', '#7c3aed'] },
  { author: 'Engr. Julius Bragais', timeAgo: 'about 1 hour ago', text: 'Wow impressive!', depth: 0 },
  { author: 'Engr. Ma. Teresa Arquero', timeAgo: 'about 2 hours ago', text: 'Wow, that is really nice.', depth: 1 },
  { author: 'Engr. Carlo Salvador', timeAgo: 'about 3 hours ago', text: 'Nice work, makes me think of The Money Pit.', depth: 2 },
  { author: 'Engr. Leonardo Ariola', timeAgo: 'about 4 hours ago', text: 'Some Documents Are Missing. Please upload a copy of Site Development', depth: 0 },
  { author: 'Applicant', timeAgo: 'about 10 hours ago', text: 'Uploaded the requested Documents.', depth: 0 },
];

export const TIMELINE: TimelineItem[] = [
  { num: '03', event: 'Application Approved', date: '18 Jun, 2026', time: '10:30 AM', detail: 'Application Approved by Engr. Ricardo Buenaflor' },
  { num: '02', event: 'Under Review', date: '28 May, 2026', time: '11:30 AM', detail: 'Application Reviewed by Engr. Ricardo Buenaflor' },
  { num: '01', event: 'Application Received', date: '13 May, 2026', time: '1:30 PM', detail: 'Application received by Engr. Ricardo Buenaflor' },
];

export const SHARED_TIMELINE: { label: string; date: string; who: string; role: string }[] = [
  { label: 'Application Submitted', date: 'April 12, 2026 | 10:30 AM', who: 'Juan Dela Cruz', role: 'Applicant' },
  { label: 'Initial Evaluation - Application in Building Approved', date: 'April 13, 2026 | 12:07 AM', who: 'Arnold M. Bermas', role: 'Engr.' },
  { label: 'Initial Evaluation - Architectural Permit Approved', date: 'April 13, 2026 | 2:07 AM', who: 'Jonathan Dizon', role: 'Architect' },
];
